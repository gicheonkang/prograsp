...
dataset_name=answerer ##########
log_dir=./aint_logs
save_dir=./OFA_checkpoints/aint/ ################
...
data=../../../train_answerer.tsv,../../../val_answerer.tsv ###############
restore_file=../../checkpoints/ofa_large.pt
selected_cols=0,4,3,2,1
...
CUDA_VISIBLE_DEVICES=1,2,3,4 python3 -m torch.distributed.launch --nproc_per_node=4 --master_port=${MASTER_PORT} ../../train.py \
    $data \
