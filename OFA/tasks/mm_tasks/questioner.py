...
from data.mm_data.questioner_dataset import questionerDataset
...
@dataclass
class questionerConfig(OFAConfig):
...
@register_task("questioner", dataclass=questionerConfig)
class questionerTask(OFATask):
    def __init__(self, cfg: questionerConfig, src_dict, tgt_dict):
    ...
    def load_dataset(self, split, epoch=1, combine=False, **kwargs):
        ...
        self.datasets[split] = questionerDataset(
            split,
            dataset,
            self.bpe,
            self.src_dict,
