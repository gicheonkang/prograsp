...
from data.mm_data.answerer_dataset import answererDataset
...
@dataclass
class answererConfig(OFAConfig):
...
@register_task("answerer", dataclass=answererConfig)
class answererTask(OFATask):
    def __init__(self, cfg: answererConfig, src_dict, tgt_dict):
    ...
    def load_dataset(self, split, epoch=1, combine=False, **kwargs):
        ...
        self.datasets[split] =answererDataset(
            split,
            dataset,
            self.bpe,
            self.src_dict,
