...
from data.mm_data.gc_dataset import gcDataset
...
@register_task("gc", dataclass=gcConfig)
class gcTask(OFATask):
    def __init__(self, cfg: gcConfig, src_dict, tgt_dict):
